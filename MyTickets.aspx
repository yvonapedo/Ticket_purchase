<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyTickets.aspx.cs" Inherits="ticket_purchase_system.MyFlights" MasterPageFile="~/Static/MasterPage.Master" %>
    ...
    <asp:Repeater ID="DataList1" runat="server">
        ...
        <ItemTemplate>       
                <div class="ticket tilt" >
                    ...
                    <h4>
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("flightDate") %>'></asp:Label></h4>
                    <div>
                        <h5>
                    ...
                    <a href='TicketDetails.aspx?ID=<%# Eval("ticketID") %>'>DETAILS</a>
                </div>
                <br />
