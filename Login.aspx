<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ticket_purchase_system.Login" MasterPageFile="~/Static/MasterLogin.Master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div style="margin: 10px 0 80px;" class="btnLogin">
        <h4 class="auto-style1">Not a member <a href="Register.aspx" target="_blank" rel=" ">REGISTER</a></h4>
